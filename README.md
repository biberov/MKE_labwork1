## 📋 Содержание
1. [Инструменты разработки](#инструменты-разработки)
2. [Цель работы](#цель-работы)
3. [Теоретическая база](#теоретическая-база)
4. [Структура программы](#структура-программы)
5. [Детальное описание файлов](#детальное-описание-файлов)


---

## <a name="инструменты-разработки"></a>💻 Инструменты разработки
...
###Подробное описание задачи см. файл to-do list.png
...
Это когда мы не можем посчитать интеграл аналитически, т.е. найти точное решение (или лень :) ), но можем приблизительно найти площадь под графиком функции.
...
h - шаг интегрирования. Он может быть как 0.1 так и 0.0001. Пример с пределом интегрирования от 0 до 1: с шагом 0.1 необходимо сделать таких шагов 10,
с шагом 0.0001 - 10000. При уменьшении шага повышается точность аппроксимации (всё ближе к необходимой функции).
...
| Библиотека | Для чего использовалась |
|------------|------------------------|
| `<iostream>` | Вывод в консоль |
| `<fstream>` | Запись результатов в файл `output.txt` |
| `<iomanip>` | Форматированный вывод (таблицы, точность) |
| `<cmath>` | Математические функции (`cos`, `sin`, `pow`, `log2`) |
| `<vector>` | Хранение данных для исследования сходимости |
| `<functional>` | Работа с указателями на функции |
